    ...
    <div class="breadcrumb-inner">
        <nav class="breadcrumb-nav" aria-label="مسیر صفحه">
            <ol class="bc-list">
                ...
                <li class="bc-sep" aria-hidden="true">/</li>
                <li class="breadcrumb-current" aria-current="page"><span>فهرست مطالب</span></li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="wrap">
    ...
    <?php else: ?>
        <div class="blog-search-wrap" data-blog-search>
            <label class="blog-search-label" for="blog-news-search-q">جستجو در اخبار</label>
            <div class="blog-search-ctrl">
                <i class="fas fa-magnifying-glass blog-search-icon" aria-hidden="true"></i>
                <input type="search" id="blog-news-search-q" class="blog-search-input" name="blog_news_q" autocomplete="off" placeholder="عنوان یا متن…" aria-label="جستجو در اخبار" aria-autocomplete="list" aria-controls="blog-news-search-results" aria-expanded="false">
                <div id="blog-news-search-results" class="blog-search-panel" role="region" aria-label="نتایج جستجو" hidden aria-hidden="true">
